  ...
  const faqData = [
    {
      ...
      answer:
        "SEO (Search Engine Optimization) helps your website rank higher on Google and other search engines. Higher rankings mean more visibility, traffic, and potential customers. We build all websites with on-page SEO, technical optimization, and content strategy to ensure your site performs well from day one.",
    },
    {
    ...
    },
    {
      ...
      answer: "We are a full-service AI and digital technology agency offering a wide range of services, including:\n\n- AI Automation & Chatbots\n- Web Design & Development (React, Next.js)\n- iOS & Android App Development\n- SEO & Digital Marketing\n- 3D Animation & Motion Graphics\n- Social Media Marketing\n- Custom Software & IT Solutions"
    },
    {
      question: "4. Can you guarantee #1 rankings on Google?",
      answer:
        "Search algorithms change constantly, and results depend on many factors beyond our control. However, we guarantee a professional, data-driven approach that improves your site’s authority, performance, and chances of ranking higher.",
    },
    {
      question: "5. Do you develop websites for mobile and tablets?",
      answer:
        "Yes, we develop responsive websites that work seamlessly on all devices, ensuring a consistent user experience across desktop, tablet, and mobile.",
    },
  ];
